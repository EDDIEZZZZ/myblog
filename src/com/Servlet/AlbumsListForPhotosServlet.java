...
@WebServlet(name = "AlbumsListForPhotosServlet")
public class AlbumsListForPhotosServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {

        try {
            Adminuser adminusersql=(Adminuser) request.getSession().getAttribute("adminuser");
            Connection conn = ConnDB.getConn();
            String sql = "select * from albums where al_author=? and is_used=true ";
            ...
            request.getRequestDispatcher("admin_photosadd.jsp").forward(request,response);
